...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_photo"))//write the name of image here it is img_product
                {
                    ...
                    photo = "DoctorPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
        ...
        String InsQry = "insert into tbl_doctors (doctors_name,doctors_contact,doctors_email,doctors_qualification,hospitalservices_id,doctors_photo)"
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Hospital/DoctorsList.jsp'
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Hospital/DoctorRegistration.jsp'
    }, 40);//40millisecend it go to next page
</script>
<%
        }
