        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("filephoto"))//write the name of image here it is img_product
                {
                    ...
                    photo = "HospitalPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                ...
                if (field_name.equals("filelogo"))//write the name of image here it is img_product
                {
                    ...
                    logo = "HospitalLogo_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                    //creating a file object
                ...
                if (field_name.equals("fileproof"))//write the name of image here it is img_product
                {
                    ...
                    proof = "HospitalProof_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                    //creating a file object
