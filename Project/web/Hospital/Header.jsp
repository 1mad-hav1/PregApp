...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- icofont CSS -->
        <link rel="stylesheet" href="../Assets/Templates/Main/css/icofont.css">
		<!-- Slicknav -->
		<link rel="stylesheet" href="../Assets/Templates/Main/css/slicknav.min.css">
		<!-- Owl Carousel CSS -->
        <link rel="stylesheet" href="../Assets/Templates/Main/css/owl-carousel.css">
		<!-- Datepicker CSS -->
		<link rel="stylesheet" href="../Assets/Templates/Main/css/datepicker.css">
		<!-- Animate CSS -->
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							<ul class="top-contact">
								...
								<li><i class="fa fa-envelope"></i><a href="mailto:support@yourmail.com">support@babyglow.com</a></li>
							</ul>
							<!-- End Top Contact -->
						</div>
					</div>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
                                                                    <a href="./Homepage.jsp"><img src="../Assets/Templates/Main/img/logo.png" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
							...
							<div class="col-lg-7 col-md-9 col-12">
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
                                                                                    <li class="active"><a href="./Homepage.jsp">Home</a>											
											</li>
                                                                                        <li><a href="./DoctorsList.jsp">Doctos </a></li>
                                                                                        <li><a href="./ServiceList.jsp">Services </a></li>
                                                                                        <li><a href="./HospitalProfile.jsp">My Profile</a>
											</li>
							...
							<div class="col-lg-2 col-12">
								<div class="get-quote">
                                                                    <a href="./ViewSchedules.jsp" class="btn">View Appointment</a>
								</div>
							</div>
						</div>
					</div>
